...
Set-PSFConfig -Module dbachecks -Name policy.database.lastfullbackupexclude -Value @('tempdb') -Initialize -Description "Databases to exclude from the last full backup check"
...
Set-PSFConfig -Module dbachecks -Name skip.database.lastfullbackup -Validation bool -Value $false -Initialize -Description "Skip the check for last full backups"
